# Plugin.Maui.DebugOverlay Template

The `Plugin.Maui.DebugOverlay` repository is a template repository that can be used to bootstrap your own .NET MAUI plugin project. You can use this project structure as a blueprint for your own work.
...
8. Make super sure that your package won't show up as `Plugin.Maui.DebugOverlay` on NuGet! If one does, you owe me a drink!
